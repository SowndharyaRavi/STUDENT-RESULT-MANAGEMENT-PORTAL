...
public class adminIndex extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "BE/BTech", "ME/MTech", "MBA", "Others" }));
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/student/result/management/portal/icons8-edit student.png"))); // NOI18N
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            Class.forName("com.mysql.jdbc.Driver");//returns instance of the class
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/mainproj","root","Sowmi@2001");//creating connection
            
            Statement st=con.createStatement();
            st.executeUpdate("insert into student values('"+rollno+"','"+name+"','"+gender+"','"+course+"','"+branch+"')");
